...
public class CpThemeSpecialActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cp_theme_special);
        ...
        competitionItemListAdapter = new CpThemeSpecialActivity.CompetitionItemListAdapter(this, R.layout.competition_list_item);
    ...
    private void getCpThemeList() {
        ...
        /** 통신처리 */
        client.init(R.string.cp_theme_list_by_me, pageno, 10, app_uid, "B");
        client.post(new BaseResponse<CompetitionThemeList>(CpThemeSpecialActivity.this) {
            @Override
            public void onResponse(CompetitionThemeList response) {
                LogHelper.debug(this, response.toString());
                if (!response.code.equals("000")) {
                    Toast.makeText(CpThemeSpecialActivity.this, response.msg, Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void btTop2Click() {
        Intent intent = new Intent(CpThemeSpecialActivity.this, CpThemeEventActivity.class);
    ...
    public void btTop3Click() {
        Intent intent = new Intent(CpThemeSpecialActivity.this, CpThemeGeneralActivity.class);
        startActivity(intent);
        finish();
    }
        ...
        public void setListItem(CompetitionTheme item, CompetitionListItemHolder holder) {
            ...
            if (item.cnt_my_participate > 0) {
                ...
                holder.btStart.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(CpThemeSpecialActivity.this, "Done", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            else {
                holder.btStart.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(CpThemeSpecialActivity.this, "Start", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            if (item.ct_status.equals("Y") && item.cnt_my_participate == 0) {
                ...
                holder.btResult.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(CpThemeSpecialActivity.this, "Not yet", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            else {
                holder.btResult.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Toast.makeText(CpThemeSpecialActivity.this, "Result", Toast.LENGTH_SHORT).show();
                    }
                });
            }

            Glide.with(CpThemeSpecialActivity.this).load(item.file_name_1).thumbnail(0.1f).into(holder.ivLeft);
            Glide.with(CpThemeSpecialActivity.this).load(item.file_name_2).thumbnail(0.1f).into(holder.ivRight);
        }
    }
